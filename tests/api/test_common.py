...
from zvt.api.quote import get_kdata, to_high_level_kdata, get_recent_report_date
...
def test_to_high_level_kdata():
    day_df = get_kdata(region=Region.CHN, provider=Provider.JoinQuant,
                       level=IntervalLevel.LEVEL_1DAY, entity_id='stock_sz_000338')
    print(day_df)
