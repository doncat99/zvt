...
def test_single_trader():
    ...
    buy_price = get_kdata(region=Region.CHN, entity_id='stock_sz_000338',
                          start_timestamp=buy_timestamp,
                          end_timestamp=buy_timestamp,
                          return_type='domain')[0]
    sell_price = get_kdata(region=Region.CHN, entity_id='stock_sz_000338',
...
def test_multiple_trader():
    ...
    # 000338
    buy_price = get_kdata(region=Region.CHN, entity_id='stock_sz_000338',
                          start_timestamp=buy_timestamp, end_timestamp=buy_timestamp,
                          return_type='domain')[0]
    sell_price = get_kdata(region=Region.CHN, entity_id='stock_sz_000338',
                           start_timestamp=sell_timestamp,
                           end_timestamp=sell_timestamp, return_type='domain')[0]
    ...
    # 601318
    buy_price = get_kdata(region=Region.CHN, entity_id='stock_sh_601318',
                          start_timestamp=buy_timestamp, end_timestamp=buy_timestamp,
                          return_type='domain')[0]
    sell_price = get_kdata(region=Region.CHN, entity_id='stock_sh_601318',
                           start_timestamp=sell_timestamp,
                           end_timestamp=sell_timestamp, return_type='domain')[0]
