...
def gen_plugin_project(entity_type, prefix: str = 'zvt', dir_path: str = '.', providers=[Provider.JoinQuant]):
    """
    ...
    entity_class = entity_type.value.capitalize()
    project_path = os.path.join(dir_path, project)
    if not os.path.exists(project_path):
        os.makedirs(project_path)

    current_time = now_pd_timestamp(Region.CHN)
