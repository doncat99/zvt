...
class VolumeUpMaFactor(TechnicalFactor):
    ...
    def __init__(self,
        ...
        columns: List = ['id', 'entity_id', 'timestamp', 'level', 'open',
...
if __name__ == '__main__':
    ...
    entities = get_entities(region=Region.CHN, provider=Provider.EastMoney,
    ...
    factor = VolumeUpMaFactor(region=Region.CHN,
